...
export const sendSignUpEmail = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.run('send-welcome-email', async () => {
            ...
            const introText = (part && 'text' in part ? part.text : null) ||'Thanks for joining Attempt Signal. You now have the tools to track markets and make smarter moves.'
...
export const sendDailyNewsSummary = inngest.createFunction(
    ...
    async ({ step }) => {
        ...
        const users = await step.run('get-all-users', async (): Promise<UserForNewsEmail[]> => getAllUsersForNewsEmail())
